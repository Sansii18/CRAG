...
class AnswerGenerator:
    def __init__(self, domain : str = "general"):
        ...
        self.templates = {
            ...
            "low_confidence": """Based on the information available, here is the answer:
            Query: {query}
            Issue : {issue}
            ...
            CONFIDENCE: LOW (<50%)
            Note: The information available is insufficient or conflicting. Exercise caution and seek expert advice.
            """
        }
